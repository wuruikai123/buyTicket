  ...
  <div class="home">
    ...
    <div class="current-exhibition">
      <div class="exhibition-content">
        ...
        <p class="exhibition-name">XXXXXXXXXXXXXXXXXXXXXXXXX双年展</p>
    ...
    <div class="upcoming-exhibitions">
      ...
      <div class="exhibition-cards">
        <div class="exhibition-card">
          ...
          <p class="card-title">XXXXXXXXXXXXXXXX展</p>
          <p class="card-date">2025/09/30</p>
        </div>
        <div class="exhibition-card">
          <div class="card-image"></div>
          <p class="card-title">XXXXXXXXXX展</p>
          <p class="card-date">2025/10/12</p>
        </div>
      </div>
    </div>
  </div>
